const vault = {
  ...
  updateVault: function (sheetName, oldVault, newVaultData) {
    try {
      ...
      var errorReport = errors.report("vault.updateVault", error, {
        sheetName: sheetName,
        oldVault: oldVault,
  ...
  version4_0: function (oldSheetID) {
    try {
      ...
      var errorReport = errors.report("vault.version4_0", error, {
        oldSheetID: oldSheetID,
      });
      return errors.fail(errorReport);
    }
  ...
  version3_1: function (oldSheetID) {
    try {
      ...
      var errorReport = errors.report("vault.version3_1", error, {
        oldSheetID: oldSheetID,
      });
      return errors.fail(errorReport);
    }
  ...
  version1_0: function (oldSheetID) {
    try {
      ...
      var errorReport = errors.report("vault.version1_0", error, {
        oldSheetID: oldSheetID,
      });
      return errors.fail(errorReport);
    }
  ...
  getVersion4_0Vault: function (oldVaultData) {
    try {
      ...
      var errorReport = errors.report("vault.getVersion4_0Vault", error, {
  ...
  parseVaultData: function (data) {
    try {
      ...
      var errorReport = errors.report("vault.parseVaultData", error, {
        data: data,
        oldVault: oldVault,
      });
      return errors.fail(errorReport);
